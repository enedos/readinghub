...
const icons = {
  ...
  authors: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="8" r="4" strokeWidth="2.1"/><path d="M4 21c1.5-4.5 5-6.5 8-6.5s6.5 2 8 6.5" strokeWidth="1.5"/></svg>,
...
const NAV = [
  ...
  { to: '/authors',      icon: icons.authors,      label: 'Autores',      group: 'biblioteca'},
